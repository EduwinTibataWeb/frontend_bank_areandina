...
const url_transacciones_usuaro= "http://localhost:9000/api/transacciones/delete/user";
...
class PageUsuarios extends Component {
    ...
    peticionDelete = () => {
      axios.delete(url_transacciones_usuaro+"/"+this.state.form.Id).then(response => {
        this.modalEliminar()
        this.peticionGet()
      }).catch(error => {
        console.log(error.message);
          ...
          <Modal isOpen={this.state.modalInsertar}>
            ...
            <ModalBody>
              <div>
                ...
                <select class="form-select" aria-label="Default select" name="rol" id="rol"  onChange={this.handleChange}>
